...
// Actuator Commands
         ...
         startup.parse("CREATE ACTUATOR ROTARY myActuator1 SENSORS mySensor3 ACCELERATION LEADIN 0.1 LEADOUT -0.2 RELAX 0.3 VELOCITY LIMIT 5 VALUE MIN 1 MAX 10 INITIAL 2 JERK LIMIT 3");
